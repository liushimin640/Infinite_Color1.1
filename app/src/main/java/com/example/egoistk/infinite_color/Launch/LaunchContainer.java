 ...
 */
public class LaunchContainer extends Container {


	public CopyOnWriteArrayList<ColorfulPix> pixChildren;
	...
	public LaunchContainer() {
		onPress = false;
		this.pixChildren = new CopyOnWriteArrayList<ColorfulPix>();
		rpaint1 = new Paint();
		rpaint2 = new Paint();
		rpaint3 = new Paint();
		wpaint = new Paint();
	...
	public CopyOnWriteArrayList<ColorfulPix> getCPChildren() {
		return this.pixChildren;
	}

	public void addPixChild(ColorfulPix child){
		this.pixChildren.add(child);
		child.parent = this;
	}

	public void removePixChild(ColorfulPix child){
		this.pixChildren.remove(child);
	}
	...
	public void draw(Canvas canvas){
		...
		for(ColorfulPix  child : this.pixChildren){
			child.draw(canvas);
		}
